...
export default function EditorialHero() {
  ...
  return (
    <section className={styles.hero}>
      ...
      <Image
        src="/hero.webp"
        alt="Thermopompe Daikin installée par Bellechasse Énergie devant une maison moderne à Montréal"
        fill
        sizes="100vw"
        preload
        className={styles.bg}
      ...
      <motion.div
        ...
        animate="visible"
      >
        <motion.h1 variants={itemVariants} className={styles.subtitle}>
          Thermopompes, climatisation et chauffage à Montréal
        </motion.h1>
