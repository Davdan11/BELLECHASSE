export const PRODUCT_CATEGORIES = [
  {
    ...
    imageFit: 'contain',
    metaTitle: 'Thermopompes centrales Daikin, Moovair',
    metaDescription:
      "Thermopompes centrales Daikin Fit, Skyair et Moovair : chauffage et climatisation de toute la maison par les conduits, conçues pour l'hiver québécois.",
    benefits: [
  ...
  },
  {
    ...
    imageFit: 'contain',
    metaTitle: 'Thermopompes murales Daikin Atmosphera',
    metaDescription:
      'Thermopompes murales Daikin Atmosphera, Oterra et multizone : installation sans conduits en une journée, chaque pièce à sa température, chauffe à -25 °C.',
    benefits: [
  ...
  },
  {
    ...
    imageFit: 'contain',
    metaTitle: 'Air climatisé central Daikin',
    metaDescription:
      'Air climatisé central Daikin DX14SA, DX16SA et FDMQ : fraîcheur uniforme dans toute la maison, silence et efficacité. Installation par Bellechasse Énergie.',
    benefits: [
  ...
  },
  {
    ...
    image: '/tab-oterra.webp',
    imageFit: 'contain',
    metaTitle: 'Air climatisé mural Daikin, Mainline',
    metaDescription:
      'Climatiseurs muraux Daikin Entra et Mainline pour rafraîchir une pièce ou un condo sans conduits. Installation rapide à Montréal et sur les rives.',
    benefits: [
  ...
  },
  {
    ...
    imageFit: 'contain',
    metaTitle: 'Fournaise électrique à air pulsé',
    metaDescription:
      'Fournaises électriques à air pulsé Steffes et Daikin MBVC : remplacement du mazout, chauffage fiable et jumelage avec une thermopompe centrale.',
    benefits: [
  ...
  },
  {
    ...
    imageFit: 'contain',
    metaTitle: "Échangeurs d'air Aldes : VRC et VRE",
    metaDescription:
      "Échangeurs d'air Aldes VRC et VRE : air neuf filtré, contrôle de l'humidité et récupération de chaleur pour une maison saine. Installation à Montréal.",
    benefits: [
